...
export default function LoginModal({ isOpen, onClose }) {
  ...
  const handleAutofill = (selectedRole) => {
    ...
    if (selectedRole === 'patient') {
      setEmail('aarav@email.com');
      setPassword('password123');
    } else if (selectedRole === 'doctor') {
      setEmail('shreya@hospital.com');
      setPassword('password123');
    } else if (selectedRole === 'admin') {
      setEmail('admin@medxpert.com');
      setPassword('password123');
    }
  };
            ...
            <div className="mb-6 bg-blue-50/50 border border-blue-100 rounded-xl p-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className="bg-white border border-blue-200 text-blue-700 font-bold py-1.5 px-2 rounded-lg text-2xs hover:bg-blue-50 transition-colors duration-150"
                >
                  🧑‍💼 Patient
                </button>
                <button
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="admin">System Admin Panel</option>
              </select>
            </div>
