    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Hero Doctor Column (Left side) */}
          <div className="lg:col-span-5 relative w-full flex justify-center lg:justify-start order-first lg:order-none animate-fadeIn">
            ...
            <div className="relative border-4 border-white shadow-2xl rounded-3xl overflow-hidden max-w-sm sm:max-w-md w-full bg-gradient-to-b from-blue-100/50 to-white/90">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-slate-900/90 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-slate-700/50">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-full bg-emerald-500/10 flex items-center justify-center text-emerald-400 flex-shrink-0 animate-pulse">
                    <span className="text-xs">🟢</span>
                  </div>
                  <div>
                    <p className="text-xs font-bold text-cyan-400 uppercase tracking-wider">Instant Teleconsultation</p>
                    <p className="text-sm font-extrabold text-white">Doctors Online Right Now</p>
                  </div>
                </div>
              </div>
            </div>
